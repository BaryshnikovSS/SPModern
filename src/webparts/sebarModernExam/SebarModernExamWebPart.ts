...
import { ISebarModernExamProps } from './components/ISebarModernExamProps';

export interface ISebarModernExamWebPartProps {
  description: string;
}

export default class SebarModernExamWebPart extends BaseClientSideWebPart<ISebarModernExamWebPartProps> {
